...
import static com.joydev.map.Constants.MAPVIEW_BUNDLE_KEY;
...
import com.joydev.map.adapters.UserRecyclerAdapter;
import com.joydev.map.models.ClusterMarker;
import com.joydev.map.models.PolylineData;
import com.joydev.map.models.User;
import com.joydev.map.models.UserLocation;
import com.joydev.map.util.MyClusterManagerRenderer;
import com.joydev.map.util.ViewWeightAnimationWrapper;
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            for (int i = 0; i < mClusterMarkers.size(); i++) {
                                try {
                                    assert updatedUserLocation != null;
...
//        setCameraView();
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.btn_full_screen_map) {
